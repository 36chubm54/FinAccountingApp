...
3. Все финансовые записи будут удалены из файла `records.json`.

### Импорт из CSV

1. Нажмите "Import from CSV".
2. Выберите CSV-файл в диалоговом окне открытия файла.
3. Подтвердите импорт в диалоговом окне (все существующие записи будут заменены).
4. Приложение покажет количество успешно импортированных записей.
...
- Строка с `TOTAL` в поле даты игнорируется
- Все существующие данные будут заменены новыми из CSV-файла
